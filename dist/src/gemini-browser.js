 ...
 */
export async function getOrCreateGeminiPage(context) {
...
// ─────────────────────────────────────────────────────────────────────────────
export async function geminiComplete(context, opts, log) {
...
export async function geminiCompleteStream(context, opts, onToken, log) {
    const model = resolveModel(opts.model);
    const prompt = flattenMessages(opts.messages);
    const timeoutMs = opts.timeoutMs ?? DEFAULT_TIMEOUT_MS;
...
//# sourceMappingURL=gemini-browser.js.map