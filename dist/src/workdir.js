...
export function getWorkdirBase() {
 ...
 */
export function createIsolatedWorkdir(base) {
 ...
 */
export function cleanupWorkdir(dirPath) {
 ...
 */
export function sweepOrphanedWorkdirs(base) {
